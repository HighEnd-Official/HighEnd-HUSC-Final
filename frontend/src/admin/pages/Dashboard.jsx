...
//   YAxis,
// } from 'recharts';
// import { addExpense, getExpenses, getOrders } from '../lib/apiRepo';
...
//     getExpenses()
//       .then((list) => {
//         if (!cancelled) setExpensesState(list);
//       })
//       .catch(() => {
//         if (!cancelled) setExpensesState([]);
//       });
//     return () => {
//       cancelled = true;
//     };
...
//     })
//       .then((saved) => {
//         setExpensesState((current) => [saved, ...current]);
...
//                 <CartesianGrid stroke="var(--admin-border)" strokeDasharray="4 4" />
//                 <XAxis dataKey="date" tick={{ fill: 'var(--color-outline)', fontSize: 11 }} />
//                 <YAxis tick={{ fill: 'var(--color-outline)', fontSize: 11 }} />
//                 <Tooltip formatter={tooltipFormatter} contentStyle={{ background: 'var(--admin-surface-strong)', border: '1px solid var(--admin-border)', borderRadius: 12 }} />
//                 <Legend />
//                 <Line type="monotone" dataKey="profit" stroke="var(--color-tertiary)" strokeWidth={2.4} dot={false} />
//                 <Line type="monotone" dataKey="expenses" stroke="var(--color-primary-container)" strokeWidth={2.0} dot={false} />
//               </LineChart>
//             </ResponsiveContainer>
//           </div>
//         </div>
...
//               <CartesianGrid stroke="var(--admin-border)" strokeDasharray="4 4" />
//               <XAxis dataKey="month" tick={{ fill: 'var(--color-outline)', fontSize: 11 }} />
//               <YAxis tick={{ fill: 'var(--color-outline)', fontSize: 11 }} />
//               <Tooltip formatter={tooltipFormatter} contentStyle={{ background: 'var(--admin-surface-strong)', border: '1px solid var(--admin-border)', borderRadius: 12 }} />
//               <Legend />
//               <Bar dataKey="profit" fill="var(--color-tertiary)" radius={[8, 8, 0, 0]} />
//               <Bar dataKey="expenses" fill="var(--color-primary-container)" radius={[8, 8, 0, 0]} />
//             </BarChart>
//           </ResponsiveContainer>
//         </div>
//       </div>
